...
![The freezer map: click to place, pick up to move, one specimen per position.](../images/09-storage.png){.screenshot fig-alt="lims-core freezer map showing a box grid with occupied and free positions and a study-colour legend"}
...
[aliquot or derive the specimen](biobank-operations.qmd),
[ship it to a central lab](shipments-and-kits.qmd), or
