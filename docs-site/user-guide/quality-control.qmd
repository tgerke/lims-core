...
Westgard rules, feeds the verdict into the [release gate](analytical-testing.qmd),
...
![The QC review board and a Levey-Jennings chart with a rule-annotated rejection.](../images/12-qc-review.png){.screenshot fig-alt="lims-core QC review page: an active-controls table and a Levey-Jennings chart showing a drift that warns then rejects on a 2-2s rule"}
