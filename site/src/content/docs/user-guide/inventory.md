...
description: A lab-wide reagent and lot catalog with an append-only consumption ledger.
---
...
![The reagent inventory: catalog, lots with expiry and on-hand quantity, and their status.](../../../assets/screenshots/10-inventory.png)
...
to each other — see [analytical testing](/lims-core/user-guide/analytical-testing/).
...
reorder alerts are not built yet — see the [roadmap](/lims-core/roadmap/).
:::
